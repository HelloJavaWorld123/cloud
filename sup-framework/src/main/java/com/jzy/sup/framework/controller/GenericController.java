package com.jzy.sup.framework.controller;


import com.jzy.sup.common.converter.json.JsonConverter;
import com.jzy.sup.common.util.CglibBeanCopierUtils;
import com.jzy.sup.framework.exception.SupException;
import com.jzy.sup.framework.service.LoginContext;
import com.jzy.sup.framework.vo.GenericVo;
 ...
 */
@Slf4j
public abstract class GenericController implements LoginContext {
    ...
    protected <T extends GenericVo> T convert(Object model, Class<T> vo) {
        try {
            ...
            throw new SupException("对象转换异常", e);
        }
    }
